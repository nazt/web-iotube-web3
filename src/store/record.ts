...
import  IoTexAllTokens  from '../../public/tokenlist/tube-iotex-tokens.json';
  ...
  constructor(rootStore: RootStore) {
    ...
    this.actionLists = [
      new ActionListState({ name: 'IoTeX',
        ...
        tokensOnNetwork: IoTexAllTokens.tokens
      }),
      new ActionListState({
        name: 'ETH',
        key: 'eth',
      ...
      new ActionListState({ name: 'BSC',
        ...
        tokensOnNetwork: iotexBscNetTokens.tokens
      }),
      new ActionListState({
        name: 'Polygon',
        key: 'polygon',
        ...
        tokensOnNetwork: iotexPolygonTokens.tokens
      })
    ];
